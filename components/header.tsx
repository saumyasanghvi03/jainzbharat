  ...
  return (
    <header className="sticky top-0 z-50 border-b border-white/10 bg-background/85 backdrop-blur-xl">
      ...
      <nav aria-label="Primary" className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 md:px-6">
        <Link aria-label="JainZBharat home" href="/" className="text-lg font-semibold tracking-tight">
        ...
        <Link href="/dashboard" className="rounded-full bg-white px-4 py-2 text-sm font-semibold text-black transition hover:bg-gold focus:outline-none focus:ring-2 focus:ring-gold">
          Join open beta
        </Link>
      </nav>
    </header>
